...
const Home = () => {
  ...
  const images = {
    defaultColor: sofaChair, color2: sofaChair2, color3: sofaChair3,
  };
  ...
  const cardVariants = {
    hidden: {opacity: 0, y: 70}, visible: {opacity: 1, y: 0},
  };

  return (<div className = "container mx-auto min-h-screen font-Raleway text-gray-800" >
    {/* MASTER CONTAINER */}
    ...
    <section
      className = "  container mx-auto bg-blue-50 h-auto sm:px-4 md:h-96 mb-12  flex flex-col md:flex-row justify-evenly items-center p-6 rounded shadow overflow-hidden " >
      {/* Text Section */}
      <div
        className = "flex flex-col items-center md:items-start justify-center text-center md:text-left px-6 space-y-4" >
