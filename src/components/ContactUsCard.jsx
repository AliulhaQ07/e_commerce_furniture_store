...
const ContactUsCard = ({ text, icon: Icon }) => {
  return (
    <motion.div
      className="flex justify-between items-center h-20 w-80 border  shadow rounded px-3 gap-3"
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center p-1 font-medium">
